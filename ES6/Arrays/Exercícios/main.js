/*
    ...
    2.2 Utilizando o filter
        Crie uma variáveis que tenha apenas os usuários que trabalham na Rocketseat e com mais de 18anos:
        [{ nome: 'Diego', idade: 23, empresa: 'Rocketseat' }]
...
const usuarios = [
    ...
    console.log('=== 2.2 ===')
    usuarios.filter(usuario => {if(usuario.empresa == 'Rocketseat' && usuario.idade > 18) console.log(usuario)});
